/*
  Redgick_MatrixLaboitePro.h - Library description ...
*/

// ensure this library description is only included once
#ifndef Redgick_MatrixLaboitePro_h
#define Redgick_MatrixLaboitePro_h
...
class Redgick_MatrixLaboitePro {
  // user-accessible "public" interface
  public:
    Redgick_MatrixLaboitePro(void);
